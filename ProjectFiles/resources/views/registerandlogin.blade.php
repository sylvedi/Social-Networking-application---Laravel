        ...
        <div class="container">
            <div class="row" style="margin-top: 67px;">
                <div id="registerForm" class="col" style="width: 563px;height: 675px;margin: 0px;padding: 0px;padding-top: 1px;color: rgba(9,22,34,0.75);background-color: #0a3d62;margin-top: 0px;margin-right: 86px;margin-left: 208px;">
                    ...
                    <form method="post" action="{{ route('register')}}" style="display: block;width: 80%;height: 315px;margin-left: 22px;padding-right: 0px;">
                    {{ csrf_field() }}
                ...
                </div><a class="already" onClick="toggleRegistration()" href="#" style="padding: 0px;padding-left: 43px;font-size: 9px;margin-left: -15px;">You already have an account? Login here.</a>
                </form>

            </div>
            <div id="loginForm" class="col" style="display: none; height: 439px;background-color: rgb(10,61,98);width: 0px;padding: 0px;padding-right: 13px;padding-left: 0px;margin-left: 59px;margin-right: 221px;">

                <form method="post" action="{{ route('login')}}" style="margin: 117px;padding: 0px;padding-top: 10px;height: 390px;margin-top: 36px;color: rgb(246,246,247);width: 80%;margin-left: 30px;margin-right: 28px;">
                {{ csrf_field() }}
                ...
                </div><a class="forgot" href="#" style="padding-left: 51px;font-size: 11px;margin-left: -13px;">Forgot your email or password?</a><br>
				<a class="already" onClick="toggleRegistration()" href="#" style="padding: 0px;padding-left: 43px;font-size: 9px;margin-left: -15px;">Sign up for an account.</a>
            </form>
            </div>
        </div>
    </div>
