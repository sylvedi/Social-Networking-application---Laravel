...
class JobController extends Controller
{
    ...
    public function displayJobForEdit(Request $request){
        ...
        $isAdmin = $sService->isAdmin($request->session()->get('UserID'));
    ...
    public function deleteJob(Request $request){
        ...
        if($isAdmin){
            ...
            if($result){
                ...
                return redirect()->route('admin')->with(['message'=>'There was an error deleting the job.']);
            }
    ...
    public function createJob(Request $request){
        ...
        if($isAdmin){
            ...
            if($result){
                ...
                return redirect()->route('admin')->with(['message'=>'There was an error creating the job.']);
            }
    ...
    public function updateJob(Request $request){
        ...
        if($isAdmin){
            ...
            if($result){
                ...
                return redirect()->route('admin')->with(['message'=>'There was an error updating the job.']);
            }
